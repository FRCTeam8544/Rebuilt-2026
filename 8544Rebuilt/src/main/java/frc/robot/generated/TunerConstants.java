...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.75).withKI(0).withKD(0.1)  //kp 0.95 during competition
    ...
    private static final Current kSlipCurrent = Amps.of(80); // 80 for Comp
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(2.0); //was 6.0
